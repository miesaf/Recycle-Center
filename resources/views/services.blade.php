            ...
            <div class="row"> <!--begin::Col-->
                <div class="row align-items-md-stretch">
                    <div class="container-fluid py-5">
                        <h1 class="display-5 fw-bold text-success">Start your eco-friendly journey with GeoRecycle today by becoming out partner!</h1>
                    </div>

                    <div class="col-md-6">
                        <div class="h-100 p-5 bg-success-subtle border rounded-3">
